...
---
****** If dinput8.dll fails to inject and Head-Tracking doesn't work, try renaming it to version.dll or winmm.dll (or secondary alternatives like dxgi.dll, xinput1_3.dll, d3d11.dll, or winhttp.dll).
## 🎮 Supported Games
