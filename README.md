...
---
****** If dinput8.dll fails to inject and Head-Tracking doesn't work, try renaming it to version.dll or winmm.dll (or secondary alternatives like dxgi.dll, d3d9.dll , wininet.dll,  xinput1_3.dll, d3d11.dll, or winhttp.dll , msacm32.dll.).
## 🎮 Supported Games
